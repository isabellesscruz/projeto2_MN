...
void calcula_spline_natural(int num_pontos, double *x, double *y,
...
int main()
{
    ...
    fprintf(arquivo_saida, "=================================\n");
    fprintf(arquivo_saida, "Spline Natural - Dados do Arquivo\n");
    fprintf(arquivo_saida, "=================================\n");
    fprintf(arquivo_saida, "Lendo %d pontos do arquivo 'entrada.txt'.\n", num_pontos);

    calcula_spline_natural(num_pontos, pontos_x, pontos_y,
